...
import { /*createSalesRequest, */createReturnRequest, customerDropdownRequest, productDropdownRequest } from '../../apiRequest/returnApiRequest'
import { useEffect } from 'react'
import { useLocation, useNavigate } from 'react-router-dom'
import store from '../../redux/store/store'
import { addToCart, onChangeReturnInput, removeFromCart, resetFormInput, resetReturnItem } from '../../redux/state/returnSlice'
  ...
  let location = useLocation()
    ...
    useEffect(() => {
        (async () => {
            ...
            store.dispatch(resetReturnItem())
        })();
    }, [location])
    ...
    let formValue = useSelector((state) => state.return.FormValue)
    let returnItem = useSelector((state) => state.return.returnItem)
    ...
    const onSave = async () => {
        if (IsEmpty(formValue.customerId)) {
            ...
            ErrorToast('Customer required.')
        } else if (IsEmpty(returnItem)) {
            ErrorToast('Your cart is Empty.')
        } else {
            if (await createReturnRequest(formValue, returnItem)) {
