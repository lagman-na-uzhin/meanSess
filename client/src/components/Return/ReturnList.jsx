...
import { deleteReturnRequest, returnListRequest, returnProductsRequest } from '../../apiRequest/returnApiRequest';
...
const ReturnList = () => {
    ...
    let Returns = useSelector((state) => (state.return.Return));
    let Total = useSelector((state) => (state.return.Total))
    let ReturnItems = useSelector((state) => (state.return.returnItem))
    ...
    const onShow = async (id) => {
        await returnProductsRequest(id)
    }
