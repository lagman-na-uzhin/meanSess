...
import { LoginRequest } from '../apiRequest/authRequest.js'
							...
							<div className="d-flex flex-column align-items-center gap-3 px-2">
							    ...
							    <div className='col-md-12 d-flex align-items-center justify-content-between'>
									...
									<div className="col-md-12">
										<button onClick={onLogin} className="btn w-100 float-end btn-success animated fadeInUp">Sign In</button>
									</div>
								<div className="col-md-12 d-flex justify-content-start">
									<span>Don't have account yet?</span>&nbsp;
									<Link className='text-success' to="/Registration">Sign Up</Link>
								</div>
								<div className="col-md-12">
