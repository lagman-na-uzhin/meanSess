...
import { ProfileDetailsRequest, UpdateProfileRequest } from '../apiRequest/authRequest'
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12 p-2">
                                        <button onClick={updateProfile}  className="btn w-100 float-end btn-success animated fadeInUp">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
